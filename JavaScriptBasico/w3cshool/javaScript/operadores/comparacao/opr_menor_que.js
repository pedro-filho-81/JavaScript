/*
   <h2>O operador menor que <mark> &lt; </mark></h2>

   <p>O operador menor que <mark> &lt; </mark> compara os valores para saber <br>se o valor1 é menor que o valor2? se for então,<br>retorna verdadeiro; caso contrário retorna falso.</p>
...
*/
   ...
   // 5 é menor que 8
   document.getElementById("demo").innerHTML = ("x é menor que 8?" + (x < 8) ); 
