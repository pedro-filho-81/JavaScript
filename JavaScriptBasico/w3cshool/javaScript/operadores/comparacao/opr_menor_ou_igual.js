/*
      <h2>O operador menor ou igual <mark> &lt;= </mark></h2>

      <p>O operador menor ou igual <mark> &lt;= </mark> compara os valores para saber <br>se o valor1 é menor ou igual ao valor2? se for então,<br>retorna verdadeiro; caso contrário retorna falso.</p>
  ...
  */
   ...
   // 5 é menor ou igual a 8
   document.getElementById("demo").innerHTML = ("x é menor ou igual a 8?" + (x <= 8) ); 
