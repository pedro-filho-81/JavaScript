/*
   <h2>O operador maior que <mark> > </mark></h2>

   <p>O operador maior que <mark> > </mark> compara os valores para saber <br>se o valor1 é maior que o valor2? se for então,<br>retorna verdadeiro; caso contrário retorna falso.</p>
...
*/
   ...
   // 5 é maior que 8
   document.getElementById("demo").innerHTML = ("x é maior que 8?" + (x > 8) ); // resultado falso